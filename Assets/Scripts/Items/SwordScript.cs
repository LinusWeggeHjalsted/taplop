...
public class SwordScript : MonoBehaviour, WeaponScript, ItemScript
{
    ...
    void Awake()
    {
        firstSkillPrefab = Resources.Load<GameObject>("Prefabs/Skills/Slice");
        firstSkill = Instantiate(firstSkillPrefab, this.transform);
        secondSkillPrefab = Resources.Load<GameObject>("Prefabs/Skills/Spinblade");
        secondSkill = Instantiate(secondSkillPrefab, this.transform);
        thirdSkillPrefab = Resources.Load<GameObject>("Prefabs/Skills/Flash Strike");
